...
<!--                      <span class="aa-badge aa-hot" href="#">HOT!</span> 인기 표시 -->
		...
		<!-- ---------------------------------------------start single product item --------------------------------------------------------->
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="productDetail.sh?product_idx=${sitrusList.product_idx }"><img src="<c:url value='/resources/img/women/girl-1.png'/>" alt="polo shirt img"></a>
                            <figcaption>
		...
		<!-- ---------------------------------------------start single product item --------------------------------------------------------->
                       <c:forEach var="aquaList" items="${aquaList }">
                        <li>
                          <figure>
                            <a class="aa-product-img" href="productDetail.sh?product_idx=${aquaList.product_idx }"><img src="<c:url value='/resources/img/women/girl-1.png'/>" alt="polo shirt img"></a>
                            <figcaption>
