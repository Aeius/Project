...
<!-- 			float: left;padding-left: 200px; padding-bottom:100px; ">What's your Pick</h4> -->
		 ...
		 <p style="text-align: center;">
	  	...
	  	<!-- 상품 상세 이미지는 여기에 -->		  	
		<img src="resources/img/recoTest/result1.jpg" style= "width:300px; height: 400px;" >
				  	
	 	<br>
	 	<br>
	  	<br>
	  	<p style="font-size: 1.7em; ">메르세데스-벤츠 클럽 블루 프레쉬 EDT</p>
 		<br>
 	 	<br>

	  	<p style="font-style: italic;"> "쾌활하고 청량한 첫 느낌을 자아내는 베르가못의 탑 노트, <br>
	  	시트러스 우디계열 깔끔한 잔향으로 은은하게 마무리되는 젊은 감각"</p>
	  	<br>
	  	<br>
		...
		메르세데스 벤츠의 고급스러운 스포츠카를 연상시키는 듯한 매끈한 실버색의 바틀에서 <br>
		엣지를 추구하는 젊은 감성을 느낄 수 있습니다.	<br>
		쾌활하고 청량한 첫 느낌으로 시작해 깔끔한 잔향으로 은은하게 마무리되는<br> 
		시트러스 아로마틱 우디 계열의 감각적인 향취입니다.
		<br>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="location.href='<c:url value='/search.sh?search=벤츠 블루'/>'">제품 보러가기</button>	 
