			...
			<section style="text-align: center; font-color: #300026; margin-top:100px;  
			 padding-bottom:100px; margin-bottom:300px;">
				...
				<!-- width 유지용 더미 div -->
			  	...
			  	<div class="select1" >
			  	<a href='<c:url value="/recoTestResult.sh?q5=7"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_4_1.jpg"/>' style="border-radius: 5px;"></a>
			  	<br> <br> 아름답고 활기찬 관광지
			  	<!-- (natural, modern +1)  -->
			  	</div>
			  	...
			  	<div class="select2"> <a href='<c:url value="/recoTestResult.sh?q5=8"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_4_2.jpg"/>' style="border-radius: 5px;"></a>
			  	<br>
			  	<br> 기억으로 남기고 싶은 해변가
			  	<!-- (sweet, natural, relax+1) -->
			  	</div>
