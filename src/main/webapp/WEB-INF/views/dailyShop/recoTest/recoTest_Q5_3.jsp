			...
			<section style="text-align: center; font-color: #300026; margin-top:100px;  
			 padding-bottom:100px; margin-bottom:300px;">
				...
				<!-- width 유지용 더미 div -->
			  	...
			  	<div class="select1" >
			  	<a href='<c:url value="/recoTestResult.sh?q5=5"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_3_1.jpg"/>' style="border-radius: 5px;"></a>
			  	<br> <br> 바람에 실려오는 들꽃, 풀내음
			  	<!-- natural, sweet +1 -->
			  	</div>
			  	
			  	
			  	
			  	<div class="select2"> <a href='<c:url value="/recoTestResult.sh?q5=6"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_3_2.jpg"/>' style="border-radius: 5px;"></a>
			  	<br>
			  	<br> 싱그럽고 시원한 물 내음
			  	<!-- natural +1 -->
			  	</div>
