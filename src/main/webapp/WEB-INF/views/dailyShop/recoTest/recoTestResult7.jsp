...
<!-- 			float: left;padding-left: 200px; padding-bottom:100px; ">What's your Pick</h4> -->
		 ...
		 <p style="text-align: center;">
	  	...
	  	<!-- 상품 상세 이미지는 여기에 -->		  	
		<img src="resources/img/recoTest/result7.jpg" style= "width:400px; height: 400px;" >
				  	
	 	<br>
	 	<br>
	  	<br>
	  	<p style="font-size: 1.7em; ">페라가모 세뇨리나 인 피오레 EDT</p>
 		<br>
 	 	<br>

	  	<p style="font-style: italic;"> "즐거움과 로맨스로 가득한 나시 배 소르베향, <br>
	  	즐겁고 다채로운 향." </p><br>
	  	<br>
	  	신선하고 활짝 핀 플로럴 향에서 비롯된 "피어나는 세뇨리나"<br>
		세뇨리나 인 피오레는 기쁨과 사랑의 설렘에 가득찬 젊은 여성을 표현합니다.<br>
		봄이 다가오면 마치 꽃이 첫 햇살에 피어나는 것 처럼,<br> 
		그녀의 로맨틱한 면을 드러냅니다.<br>
		<br>
		선명한 핑크색 바틀은 핑크골드 캡과 아이코닉한 핑크 바라보우로 장식 되어 있습니다. <br>
		아우터 패키지는 낭만적이면서도 화려한 반전의 매력을 통해 특별함을 표현합니다.
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="location.href='<c:url value='/search.sh?search=세뇨리나 인 피오레'/>'">제품 보러가기</button>	 
