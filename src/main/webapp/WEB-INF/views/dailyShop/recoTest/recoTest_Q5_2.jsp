			...
			<section style="text-align: center; font-color: #300026; margin-top:100px;  
			 padding-bottom:100px; margin-bottom:300px;">
				...
				<!-- width 유지용 더미 div -->
			  	...
			  	<div class="select1" >
			  	<a href='<c:url value="/recoTestResult.sh?q5=3"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_2_1.jpg"/>' style="border-radius: 5px;"></a>
			  	<br> <br> 디너테이블 위 꽃다발
			  	<!-- sweet +1 -->
			  	</div>
			  	...
			  	<div class="select2"> <a href='<c:url value="/recoTestResult.sh?q5=4"/>'>&nbsp;&nbsp;
			  	<img src='<c:url value="/resources/img/recoTest/5_2_2.jpg"/>' style="border-radius: 5px;"></a>
			  	<br>
			  	<br> 정장에 어울리는 악세서리
			  	<!--  modern +1 -->
			  	</div>
