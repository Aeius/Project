...
<!-- 			float: left;padding-left: 200px; padding-bottom:100px; ">What's your Pick</h4> -->
		 ...
		 <p style="text-align: center;">
	  	...
	  	<!-- 상품 상세 이미지는 여기에 -->		  	
		<img src="resources/img/recoTest/result8.JPG" style= "width:300px; height: 400px;" >
				  	
	 	<br>
	 	<br>
	  	<br>
	  	<p style="font-size: 1.7em; ">메종 마르지엘라 버블 바스 EDT</p>
 		<br>
 	 	<br>
	  	<p style="font-style: italic;"> "거품목욕으로 긴장을 풀고 있던 느긋한 순간과 기억을 포착한 향"</p>
	  	<br>
	  	<br>
	  	
		2005년 베벌리힐즈-<br> 
		주말 아침에 부드러운 비눗방울 향과 코코넛 밀크의 촉촉함이 더해져 따뜻한 거품목욕의 평온함을 연상시키며 <br>
		화이트 머스크의 은은한 향이 목욕을 마친 후의 편안함을 생각나게하는 시프레 플로럴 계열의 향수입니다
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="location.href='<c:url value='/search.sh?search=버블 바스'/>'">제품 보러가기</button>	 
