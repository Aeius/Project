...
<!-- 			float: left;padding-left: 200px; padding-bottom:100px; ">What's your Pick</h4> -->
		 ...
		 <p style="text-align: center;">
	  	...
	  	<!-- 상품 상세 이미지는 여기에 -->		  	
		<img src="resources/img/recoTest/resultReal12.jpg" style= "width:300px; height: 400px;" >
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="location.href='<c:url value='/search.sh?search=씨솔트'/>'">제품 보러가기</button>	 
