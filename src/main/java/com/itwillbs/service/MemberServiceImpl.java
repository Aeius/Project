	...
	public void sendTempPassword(MemberBean mb) {
		 ...
		 String setfrom = "javateamproject2021@gmail.com";
	      ...
	      String content = "<p align=\"center\" style=\"text-align: center; \">&nbsp;<span style=\"font-size: 10pt;\">&nbsp;</span></p><p align=\"center\" style=\"text-align: center; \">"
	      		...
	      		+ "<b><a href=\"http://itwillbs14.cafe24.com/PERFUMESHIP/login.sh\" target=\"_blank\" style=\"cursor: pointer; white-space: pre;\" rel=\"noreferrer noopener\">"
	      		...
	      		+ "<p align=\"center\" style=\"text-align: center; \"><span style=\"font-family: dotum, sans-serif;\"><span></span><a href=\"http://itwillbs14.cafe24.com/PERFUMESHIP/notice.sh\" target=\"_blank\" style=\"cursor: pointer; white-space: pre;\" rel=\"noreferrer noopener\">"
...
// ---------------------------------------------   이메일 보내기 -----------------------------------------------   
   ...
   public void sendWelcomeMail(MemberBean memberBean) {
      ...
      String content = "<div align=\"center\" style=\"text-align: center;\"><span style=\"font-size: 24pt; font-family: arial, sans-serif;\">"
            ...
            + "<form action=\"http://itwillbs14.cafe24.com/PERFUMESHIP/main.sh\" method=\"get\"><input type=\"submit\" value=\"쿠폰 등록하러가기\" style=\"border:1px solid #f4f4f4; padding: 7px 15px; border-radius:8px; background-color: rgb(81, 143, 187);color:white; cursor: pointer;\"></form></div>"; // 내용
